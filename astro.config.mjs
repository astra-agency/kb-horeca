    ...
    starlight({
      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            { label: 'All Cases', translations: { ru: 'Все кейсы', zh: '全部案例' }, slug: 'cases' },
            {
              label: 'CRM & Sales',
              translations: { ru: 'CRM и продажи', zh: 'CRM与销售' },
              items: [
                { label: 'CRM Setup', translations: { ru: 'Внедрение CRM', zh: 'CRM实施' }, slug: 'cases/crm-setup' },
                { label: 'PMS/CRM Integration', translations: { ru: 'Интеграция CRM с PMS/POS', zh: 'PMS/CRM集成' }, slug: 'cases/pms-crm-integration' },
                { label: 'Personalized Proposals', translations: { ru: 'Персонализированные КП', zh: '个性化提案' }, slug: 'cases/personalized-proposals' },
                { label: 'Online Payment Link', translations: { ru: 'Онлайн-оплата по ссылке', zh: '在线支付链接' }, slug: 'cases/online-payment-link' },
              ],
            },
            {
              ...
              items: [
                { label: 'Loyalty Program', translations: { ru: 'Программа лояльности', zh: '忠诚度计划' }, slug: 'cases/loyalty-program' },
                { label: 'Referral System', translations: { ru: 'Реферальная система', zh: '推荐系统' }, slug: 'cases/referral-system' },
                { label: 'Guest Portal', translations: { ru: 'Личный кабинет гостя', zh: '宾客门户' }, slug: 'cases/guest-portal' },
              ],
            },
            {
              ...
              items: [
                { label: 'Booking Engine', translations: { ru: 'Модуль онлайн-бронирования', zh: '预订引擎' }, slug: 'cases/booking-engine' },
                { label: 'RMS — Dynamic Pricing', translations: { ru: 'RMS — динамические цены', zh: 'RMS — 动态定价' }, slug: 'cases/rms-dynamic-pricing' },
                { label: 'Rate Shopper', translations: { zh: '价格对比' }, slug: 'cases/rate-shopper' },
              ],
            },
            {
              ...
              items: [
                { label: 'HR Processes', translations: { ru: 'HR-процессы', zh: 'HR流程' }, slug: 'cases/hr-automation' },
                { label: 'Legal Department', translations: { ru: 'Юридический отдел', zh: '法务部门' }, slug: 'cases/legal-automation' },
                { label: 'Marketing & Feedback', translations: { ru: 'Маркетинг и обратная связь', zh: '营销与反馈' }, slug: 'cases/marketing-feedback-automation' },
              ],
            },
            {
              ...
              items: [
                { label: 'Staff Mobile App', translations: { ru: 'Приложение для персонала', zh: '员工移动应用' }, slug: 'cases/staff-mobile-app' },
                { label: 'Self-Service Kiosks', translations: { ru: 'Киоски самообслуживания', zh: '自助服务终端' }, slug: 'cases/kiosk-apps' },
              ],
            },
            {
              ...
              items: [
                { label: 'Inventory Management', translations: { zh: '库存管理' }, slug: 'cases/inventory-management' },
                { label: 'Vendor Management', translations: { zh: '供应商管理' }, slug: 'cases/vendor-management' },
                { label: 'Logistics Optimization', translations: { zh: '物流优化' }, slug: 'cases/logistics-optimization' },
              ],
            },
            {
              ...
              items: [
                { label: 'Employee Training', translations: { zh: '员工培训' }, slug: 'cases/employee-training' },
                { label: 'Compliance & Risk', translations: { zh: '合规与风险' }, slug: 'cases/compliance-risk' },
              ],
            },
            {
              label: 'Finance & IT',
              ...
              items: [
                { label: 'Financial Management', translations: { zh: '财务管理' }, slug: 'cases/financial-management' },
                { label: 'IT Infrastructure', translations: { zh: 'IT基础设施' }, slug: 'cases/it-infrastructure' },
              ],
            },
          ],
        },
