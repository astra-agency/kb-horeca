...
- [Программа лояльности](/kb-horeca/cases/loyalty-program/) — цифровая механика накопления баллов и статусов
- [Реферальная система](/kb-horeca/cases/referral-system/) — как постоянные гости приводят новых через реферальные ссылки
- [Личный кабинет гостя](/kb-horeca/cases/guest-portal/) — персональное пространство для истории визитов и бонусов
