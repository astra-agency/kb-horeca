...
- [Личный кабинет гостя](/kb-horeca/cases/guest-portal/) — цифровая точка взаимодействия на каждом этапе цикла
- [Мобильное приложение для персонала](/kb-horeca/cases/staff-mobile-app/) — инструмент идентификации и экстренной связи в реальном времени
