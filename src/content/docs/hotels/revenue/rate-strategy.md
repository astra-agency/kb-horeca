...
- [RMS — динамическое ценообразование](/cases/rms-dynamic-pricing/) — автоматическое управление тарифами по загрузке
- [Rate Shopper — парсинг цен конкурентов](/cases/rate-shopper/) — мониторинг конкурентного поля в реальном времени
