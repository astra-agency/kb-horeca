...
- [RMS — динамическое ценообразование](/use-cases/rms-dynamic-pricing/) — как автоматика управляет RevPAR через загрузку
- [Rate Shopper](/use-cases/rate-shopper/) — данные для обоснованных ценовых решений
