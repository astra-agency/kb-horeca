...
- [RMS — динамическое ценообразование](/use-cases/rms-dynamic-pricing/) — автоматическая реакция на изменение загрузки в межсезонье
- [Автоматизация маркетинга и обратной связи](/use-cases/marketing-feedback-automation/) — триггерные кампании по базе для повторного визита
