...
- [Модуль онлайн-бронирования](/use-cases/booking-engine/) — как реализовать прямой канал технически
- [Программа лояльности](/use-cases/loyalty-program/) — механика удержания гостей в прямом канале
- [Реферальная система](/use-cases/referral-system/) — привлечение новых гостей через рекомендации
