...
- [Модуль онлайн-бронирования](/cases/booking-engine/) — как реализовать прямой канал технически
- [Программа лояльности](/cases/loyalty-program/) — механика удержания гостей в прямом канале
- [Реферальная система](/cases/referral-system/) — привлечение новых гостей через рекомендации
