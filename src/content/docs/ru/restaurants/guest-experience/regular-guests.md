...
- [Программа лояльности](/use-cases/loyalty-program/) — цифровая механика накопления баллов и статусов
- [Реферальная система](/use-cases/referral-system/) — как постоянные гости приводят новых через реферальные ссылки
- [Личный кабинет гостя](/use-cases/guest-portal/) — персональное пространство для истории визитов и бонусов
