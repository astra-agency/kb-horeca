# Food Cost and Menu Pricing: Food Cost %, Beverage Cost, Pricing Methods

> **Series:** Restaurants — Menu and Economics  
> **Level:** Practical  
> **Audience:** Restaurant owners, executive chefs, GMs, F&B directors
...
### 1. Food Cost Per Dish (Portion Cost)
...
### Method 1: Cost-Plus (Classic Approach)
```
...
## Working Without a POS System

**Manual tracking (Google Sheets):**
- Recipe costing card for every menu item
- Weekly hand count of key inventory items (proteins, spirits, top-selling items)
- Monthly comparison: theoretical FC (based on sales mix × recipe costs) vs. actual purchases

**With a POS system:**
Most modern systems (Toast, Square for Restaurants, Lightspeed) automatically calculate theoretical food cost against recipe costing cards and flag variance when actual purchases are imported.
