# Direct Bookings vs. OTA: How to Reduce Your Dependency on Aggregators

> **Series:** Hotels — Revenue & Demand Management  
> **Level:** Strategic  
> **Audience:** Property owners, sales and marketing directors
...
### 5. Metasearch and Google Hotel Ads
...
## OTA as a Tool, Not a Dependency
...
| Metric | Danger Zone | Target |
|---|---|---|
| OTA share of booking mix | >60% | <40% |
| Direct booking share | <20% | >35% |
| OTA cancellation rate | — | Monitor monthly |
| Cost per acquisition (CPA) by channel | — | Calculate monthly |
...
- Teacode.io — *The Secret to Reduce OTA Dependence for Hotels* (2026). https://www.teacode.io/blog/reducing-ota-dependence-in-hospitality
